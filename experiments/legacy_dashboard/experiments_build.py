...
Run:
    python -m experiments.legacy_dashboard.experiments_build \
        --behavioral artifacts/runs/behavioral/qwen3_5-4b \
        --concept artifacts/runs/concept_detect/qwen3_5-4b.json \
        --out artifacts/figures/dashboard_data/_experiments.json
"""
...
def main() -> None:
    ...
    ap.add_argument("--behavioral", default="artifacts/runs/behavioral/qwen3_5-4b")
    ap.add_argument("--concept", default="artifacts/runs/concept_detect/qwen3_5-4b.json")
    ap.add_argument("--out", default="artifacts/figures/dashboard_data/_experiments.json")
    args = ap.parse_args()
