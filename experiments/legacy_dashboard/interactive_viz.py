...
Usage:
    python -m experiments.legacy_dashboard.interactive_viz \
        --dict "Qwen3.5-2B L19 p4=pkl:artifacts/runs/qwen3_5-2b_L19_p4p0_ctx128_cache_pile/dictionary.pkl" \
        --dict "Gemma-2-2B L12 p4=hub:gemma-2-2b,12,4" \
        --out artifacts/figures/ep_explorer.html
"""
...
REPO = Path(__file__).resolve().parents[2] / "exemplar-partitioning"
...
def main() -> None:
    ...
    ap.add_argument("--out", default="artifacts/figures/ep_explorer.html")
