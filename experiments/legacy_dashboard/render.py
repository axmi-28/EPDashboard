...
Usage:
    python -m experiments.legacy_dashboard.render --data artifacts/figures/dashboard_data \
        --out artifacts/figures/ep_dashboard.html [--only key1,key2]
"""
...
def main() -> None:
    ...
    ap.add_argument("--data", default="artifacts/figures/dashboard_data")
    ap.add_argument("--out", default="artifacts/figures/ep_dashboard.html")
