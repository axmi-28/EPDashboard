...
Example:
    python -m experiments.persona.build --stage extract \
        --rollouts artifacts/runs/persona_axis/qwen3_5-4b_spectrum_q16_sp3_seed0/rollouts.jsonl \
        --layer 27
    python -m experiments.persona.build --stage build --layer 27 --percentile 8
    python -m experiments.persona.build --stage build --layer 27 --percentile 4
"""
...
log = logging.getLogger("experiments.persona.build")
...
def main() -> None:
    ...
    ap.add_argument("--cache-dir", default="artifacts/runs/persona_dict")
    args = ap.parse_args()
