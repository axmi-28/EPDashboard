...
Example:
    python -m experiments.persona.drift \
        --dict artifacts/runs/qwen3_5-4b_L27_p8p0_ctx128_cache_pile \
        --axis-npz artifacts/runs/persona_axis/qwen3_5-4b_spectrum_q16_sp3_seed0/axis_L16.npz \
        --localize artifacts/runs/persona_axis/qwen3_5-4b_spectrum_q16_sp3_seed0/persona_localize_p8.json
"""
...
log = logging.getLogger("experiments.persona.drift")
...
def main() -> None:
    ...
    ap.add_argument("--output-dir", default="artifacts/runs/persona_drift")
    args = ap.parse_args()
    run(args)
