...
Run:
    python -m qwen_ep.concept_detect \
        --dicts runs/qwen3_5-4b_L27_p2p0_ctx128_cache_pile,... \
        --n-concepts 48 --out runs/concept_detect/qwen3_5-4b.json
"""
...
logger = logging.getLogger("qwen_ep.concept_detect")
...
def main() -> None:
    ...
    cache = Path("runs/concept_detect") / model_tag(args.model_id) / "_actcache"
    ...
    out_path = Path(args.out or
                    f"runs/concept_detect/{model_tag(args.model_id)}.json")
