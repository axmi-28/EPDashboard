...
Usage:
    python -m qwen_ep.dashboard_build --lens-cache <dir> --out figures/dashboard_data
"""
...
DICTS = [
    dict(key="qwen-L19-p8", model="Qwen3.5-2B-Base", model_key="qwen",
         ...
         path="runs/qwen3_5-2b_L19_p8p0_ctx128_cache_pile/dictionary.pkl",
         meta="runs/qwen3_5-2b_L19_p8p0_ctx128_cache_pile/metadata.json"),
    dict(key="qwen-L19-p4", model="Qwen3.5-2B-Base", model_key="qwen",
         tokenizer="Qwen/Qwen3.5-2B-Base", layer=19, p=4, bos_offset=0,
         path="runs/qwen3_5-2b_L19_p4p0_ctx128_cache_pile/dictionary.pkl",
         meta="runs/qwen3_5-2b_L19_p4p0_ctx128_cache_pile/metadata.json"),
    dict(key="qwen-L12-p8", model="Qwen3.5-2B-Base", model_key="qwen",
         tokenizer="Qwen/Qwen3.5-2B-Base", layer=12, p=8, bos_offset=0,
         path="runs/qwen3_5-2b_L12_p8p0_ctx128_mt1000000_seed0_pile/dictionary.pkl",
         meta="runs/qwen3_5-2b_L12_p8p0_ctx128_mt1000000_seed0_pile/metadata.json"),
    dict(key="qwen4b-it-L27-p8", model="Qwen3.5-4B (instruct)", model_key="qwen4b",
         tokenizer="Qwen/Qwen3.5-4B", layer=27, p=8, bos_offset=0,
         path="runs/qwen3_5-4b_L27_p8p0_ctx128_cache_pile/dictionary.pkl",
         meta="runs/qwen3_5-4b_L27_p8p0_ctx128_cache_pile/metadata.json"),
    dict(key="qwen4b-it-L27-p4", model="Qwen3.5-4B (instruct)", model_key="qwen4b",
         tokenizer="Qwen/Qwen3.5-4B", layer=27, p=4, bos_offset=0,
         path="runs/qwen3_5-4b_L27_p4p0_ctx128_cache_pile/dictionary.pkl",
         meta="runs/qwen3_5-4b_L27_p4p0_ctx128_cache_pile/metadata.json"),
    dict(key="qwen4b-base-L27-p8", model="Qwen3.5-4B-Base", model_key="qwen4b-base",
         ...
         path="runs/qwen3_5-4b-base_L27_p8p0_ctx128_cache_pile/dictionary.pkl",
         meta="runs/qwen3_5-4b-base_L27_p8p0_ctx128_cache_pile/metadata.json"),
    dict(key="qwen4b-base-L27-p4", model="Qwen3.5-4B-Base", model_key="qwen4b-base",
         ...
         path="runs/qwen3_5-4b-base_L27_p4p0_ctx128_cache_pile/dictionary.pkl",
         meta="runs/qwen3_5-4b-base_L27_p4p0_ctx128_cache_pile/metadata.json"),
    ...
    dict(key="qwen27b-L55-p8", model="Qwen3.6-27B", model_key="qwen27b",
         ...
         path="runs/qwen3_6-27b_L55_p8p0_ctx128_cache_pile/dictionary.pkl",
         meta="runs/qwen3_6-27b_L55_p8p0_ctx128_cache_pile/metadata.json"),
    dict(key="qwen27b-L55-p12", model="Qwen3.6-27B", model_key="qwen27b",
         tokenizer="Qwen/Qwen3.6-27B", layer=55, p=12, bos_offset=0,
         path="runs/qwen3_6-27b_L55_p12p0_ctx128_cache_pile/dictionary.pkl",
         meta="runs/qwen3_6-27b_L55_p12p0_ctx128_cache_pile/metadata.json"),
    dict(key="qwen27b-L55-p16", model="Qwen3.6-27B", model_key="qwen27b",
         tokenizer="Qwen/Qwen3.6-27B", layer=55, p=16, bos_offset=0,
         path="runs/qwen3_6-27b_L55_p16p0_ctx128_cache_pile/dictionary.pkl",
         meta="runs/qwen3_6-27b_L55_p16p0_ctx128_cache_pile/metadata.json"),
    dict(key="qwen27b-L55-p4", model="Qwen3.6-27B", model_key="qwen27b",
         tokenizer="Qwen/Qwen3.6-27B", layer=55, p=4, bos_offset=0,
         path="runs/qwen3_6-27b_L55_p4p0_ctx128_cache_pile/dictionary.pkl",
         meta="runs/qwen3_6-27b_L55_p4p0_ctx128_cache_pile/metadata.json"),
...
def build_one(spec: dict, lens: dict, out_dir: Path,
    ...
    if with_neighbors:
        ...
        from qwen_ep.neighborhood import all_neighborhoods
...
def main() -> None:
    ...
    ap.add_argument("--out", default="figures/dashboard_data")
