...
Example:
    python -m qwen_ep.persona_axis --roles spectrum \
...
from .persona_data import DEFAULT_ROLE, build_rollout_specs, resolve_roles

log = logging.getLogger("qwen_ep.persona_axis")
...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--output-dir", default="runs/persona_axis")
