...
Run:
    python -m qwen_ep.testing_build \
        --refusal-dict runs/behavioral/qwen3_5-4b/L27_p12_seed0 \
        --behavioral-root runs/behavioral/qwen3_5-4b \
        --concept-json runs/concept_detect/qwen3_5-4b.json \
        --concept-dict runs/qwen3_5-4b_L27_p8p0_ctx128_cache_pile \
        --out figures/dashboard_data/_testing.json
"""
...
from .dashboard_build import knn, layouts
...
def main() -> None:
    ...
    ap.add_argument("--refusal-dict", default="runs/behavioral/qwen3_5-4b/L27_p12_seed0")
    ap.add_argument("--behavioral-root", default="runs/behavioral/qwen3_5-4b")
    ap.add_argument("--concept-json", default="runs/concept_detect/qwen3_5-4b.json")
    ap.add_argument("--concept-dict", default="runs/qwen3_5-4b_L27_p8p0_ctx128_cache_pile")
    ap.add_argument("--out", default="figures/dashboard_data/_testing.json")
    args = ap.parse_args()
